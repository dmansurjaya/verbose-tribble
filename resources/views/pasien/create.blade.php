          ...
          <div class="row">
            <div class="col-md-4 col-sm-6  ">
              ...
              <div class="form-group row">
                <div class="col-md-12 col-sm-3  form-group has-feedback">
                  <input name="Nomor_Identitas"type="text" class="form-control" id="inputSuccess2" placeholder="Nomor Identitas">
                  <span  aria-hidden="true"></span>
                </div>
              </div>
              <div class="form-group row ">
                <div class="col-md-12 col-sm-3  form-group has-feedback">
                  <input name="nama_lengkap"type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="nama_lengkap">
